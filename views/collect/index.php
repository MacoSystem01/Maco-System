        ...
        <section class="contenedor">
            ...
            <section class="contenido" id="contenidoGeneral">
                <div class="encabezadoContenido">
                    <div class="tituloContenido"><h1>GESTIÓN RECAUDO</h1></div><div class="agregarDato">
                        <a href="add_collect.php"><input type="button" value="Agregar"></a></div><div class="buscar">
                            <input type="text" id="txbSearchCollect" placeholder="Buscar...">
                        </div>                    
                </div>
                <div class="listado">
                    ...
                    <form method="post" action="">
                        <table>
                            ...
                            foreach ($objCollectImpl->getAll() as $valor) {
                                ?>
                                <tr>
                                    <td class="tdDerecha"><?php echo $valor->getCode(); ?></td>                                                                    
                                    <td class="tdDerecha"><?php echo $valor->getCodeCredit(); ?></td>                                                              
                                    ...
                                    <td id="tdAcciones">
                                        <?php
                                        echo '<a href="edit_collect.php?idr='.$valor->getCode().'"><img src="../../res/edit-16.png"></a>';
                                        echo '<a class="aDelete" href="../../controllers/ctrlDeleteCollect.php?idr='.$valor->getCode().'&idc='.$valor->getCodeCredit().'"><img src="../../res/delete-16.png"></a>';                                        
                                        echo '<a target="_blank" href="../../controllers/ctrlPrintCollect.php?id='.$valor->getCode().'&idc='.$valor->getCodeCredit().'"><img src="../../res/printer-2-16.png"></a>';     
                                        ?>                                        
                                    </td>  
                                </tr>
                                <?php
                    ...
                    <?php echo '<p>Ultimos registros de '.$objCollectImpl->getCount().' encontrados</p>';   ?>
