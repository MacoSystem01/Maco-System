        ...
        <section class="contenedor">
            ...
            <section class="contenido" id="contenidoGeneral">
                ...
                <div class="encabezadoContenido">
                    <div class="tituloContenido"><h1>Seleccionar Crédito</h1></div><div class="agregarDato"></div><div class="buscar">
                            <input type="text" id="txbSearchCreditCollect" placeholder="Buscar...">
                    </div>                    
                </div>
                ...
                <div class="listadoCreditBill">
                    ...
                    <form method="post" action="">
                        <table>
                            ...
                            foreach ($objCreditImpl->getByStateAC() as $valor) {
