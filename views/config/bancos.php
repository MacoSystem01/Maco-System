        ...
        <section class="contenedor">
            ...
            <section class="contenido" id="contenidoGeneral">
                <div class="encabezadoContenido">
                    <div class="tituloContenido"><h1>GESTIÓN BANCO</h1></div><div class="agregarDato">
                        <a href="add_banco.php"><input type="button" value="Agregar"></a></div><div class="buscar">
                            <input type="text" id="txbSearchBanks" placeholder="Buscar...">
                        </div>                    
                </div>
                <div class="listado">
                    ...
                    <form method="post" action="">
                        <table>
                            ...
                            <?php
                            require '../../models/BancosImpl.php';
                            $objBancosImpl = new BancosImpl();
                            
                            foreach ($objBancosImpl->getAll() as $valor) {
                                ?>
                                <tr>
                                    <td class="tdCenter"><?php echo $valor->getCode(); ?></td>                                
                                    <td><?php echo $valor->getName(); ?></td>                                                              
                                    <td><?php echo $valor->getGenerationDate(); ?></td>                                                              
                                    <td class="tdDerecha"><?php echo number_format($valor->getValor()); ?></td>                                                              
                                    <td id="tdAcciones">
                                        <?php
                                        echo '<a href="edit_banco.php?id='.$valor->getCode().'"><img src="../../res/edit-16.png"></a>';
//                                        echo '<a class="aDelete" href="../../controllers/ctrlDeleteConcept.php?id='.$valor->getCode().'"><img src="../../res/delete-16.png"></a>';                                        
                    ...
                    <?php echo '<p>Ultimos registros de '.$objBancosImpl->getCount().' encontrados</p>';   ?>
                ...
                if(isset($_GET['em']))
                {
                    echo '<script>alertify.error("El banco no se puede eliminar, favor revisar");</script>';          
                }
                ?>
