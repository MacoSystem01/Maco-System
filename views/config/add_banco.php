        ...
        <section class="contenedor">
            ...
            {?>
                <section class="contenido" id="contenidoGeneral">
                    <h1>AGREGAR BANCO</h1>
                    <form method="post" action="../../controllers/ctrlInsertBanco.php">
                        ...
                        <?php echo '<input type="text" value="'.$_GET['n'].'" name="txbValor" id="example2" placeholder="Valor" maxlength="60" required>'; ?>
            ...
            <?php
                ...
                <section class="contenido" id="contenidoGeneral">
                    ...
                    <form method="post" action="../../controllers/ctrlInsertBanco.php">
						...
						<input type="text" name="txbValor" placeholder="Valor" id="example2" maxlength="60" required>						
                        <input type="submit" value="Guardar">
                    </form>
