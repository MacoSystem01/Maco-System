...
<html>
    <head>
        ...
        <title>MACO | REPORTE ESTADO CUENTA PROVEEDOR</title>
    </head>
    <body>
        <section class="contenedor">
            <header>
                <div class="logoEmpresa">
                    <a href="../../index.php"><img src="../../res/logo/logo-1.png"></a></div><div class="sesion">
            ...
            <section class="contenido" id="contenidoGeneral2">
                ...
                if($_POST)
                {?>
                    <form id="formReporteEstadoCuentaProveedor" method="post">
                        <?php 
                        ...
                        ?>                        
                        <input id="btnConsultarEstadoCuentaProveedor" type="submit" value="Consultar">
                        <input id="btnGenerarEstadoCuentaProveedor" type="submit" value="Generar PDF">
                    </form>    
                <?php
                }
                else
                ...
                <div class="listado">                                      
                    ...
                    if($_POST)
                    {
                        ...
                        if($dateFin>=$dateInicio){
                            ...
                            if ($objCreditImpl->getCountCreditOnlyBetweenDate_PROVE($_POST['txbFechaInicio'], $_POST['txbFechaFin']) > 0)
                            {
                            ...
                            <?php
                                ...
                                echo '<script>alertify.error("No se encontro información");</script>';                                
                            }
